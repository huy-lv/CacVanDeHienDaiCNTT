...
import com.uet.launcher3.DropTarget.DragObject;
import com.uet.launcher3.PagedView.PageSwitchListener;
import com.uet.launcher3.allapps.AllAppsContainerView;
import com.uet.launcher3.allapps.PredictiveAppsProvider;
import com.uet.launcher3.compat.AppWidgetManagerCompat;
...
import com.uet.launcher3.model.WidgetsModel;
import com.uet.launcher3.util.ComponentKey;
import com.uet.launcher3.util.LongArrayMap;
import com.uet.launcher3.util.Thunk;
import com.uet.launcher3.widget.PendingAddWidgetInfo;
import com.uet.launcher3.widget.WidgetHostViewLoader;
import com.uet.launcher3.widget.WidgetsContainerView;
...
public class Launcher extends Activity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.uet.launcher3.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    static final String ACTION_FIRST_LOAD_COMPLETE =
            "com.uet.launcher3.action.FIRST_LOAD_COMPLETE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gd = new GestureDetector(this, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                Toast.makeText(Launcher.this, "double tap", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
...
//        	Log.e("cxz","mlaunchercallback ==null");
...
//            return !Utilities.isRotationAllowedForDevice(this);
    ...
    private void setupViews() {
        ...
        Log.e("cxz","hassetting:"+hasSettings());
        if (hasSettings()) {
...
interface DebugIntents {
    static final String DELETE_DATABASE = "com.uet.launcher3.action.DELETE_DATABASE";
    static final String MIGRATE_DATABASE = "com.uet.launcher3.action.MIGRATE_DATABASE";
}